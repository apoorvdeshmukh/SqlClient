...
public class SqlVectorTest
{
    ...
    public void Construct_Length()
    {
        ...
        Assert.Equal(new ReadOnlyMemory<float>().ToArray(), vec.Values.ToArray());
    ...
    public void Construct_Memory()
    {
        ...
        Assert.Equal(memory.ToArray(), vec.Values.ToArray());
    ...
    public void Construct_Memory_ImplicitConversionFromFloatArray()
    {
        ...
        Assert.Equal(new ReadOnlyMemory<float>(data).ToArray(), vec.Values.ToArray());
        Assert.Equal(data, vec.ToArray());
        #if NETFRAMEWORK
